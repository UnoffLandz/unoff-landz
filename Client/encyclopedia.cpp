...
int click_encyclopedia_handler(window_info *win, int mx, int my, uint32_t flags)
{
    _Text *t=Page[currentpage].T.Next;
...
*/
int keypress_encyclopedia_handler(window_info *win, int mx, int my, uint32_t key, uint32_t unikey)
{
...
void fill_encyclopedia_win ()
{
    ...
    set_window_handler (encyclopedia_win, ELW_HANDLER_CLICK, (int (*)())&click_encyclopedia_handler);
    ...
    set_window_handler(encyclopedia_win, ELW_HANDLER_MOUSEOVER, (int (*)())&mouseover_encyclopedia_handler);
    set_window_handler(encyclopedia_win, ELW_HANDLER_KEYPRESS, (int (*)())&keypress_encyclopedia_handler);
