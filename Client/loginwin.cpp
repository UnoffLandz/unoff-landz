...
int resize_login_handler (window_info *win, uint32_t w, uint32_t h)
{
...
int click_login_handler (window_info *win, int mx, int my, uint32_t flags)
{
...
int keypress_login_handler (window_info *win, int mx, int my, uint32_t key, uint32_t unikey)
{
...
void create_login_root_window (int width, int height)
{
    if (login_root_win < 0)
    {
        ...
        set_window_handler (login_root_win, ELW_HANDLER_MOUSEOVER, (int (*)())&mouseover_login_handler);
        set_window_handler (login_root_win, ELW_HANDLER_CLICK, (int (*)())&click_login_handler);
        set_window_handler (login_root_win, ELW_HANDLER_KEYPRESS, (int (*)())&keypress_login_handler);
        set_window_handler (login_root_win, ELW_HANDLER_RESIZE, (int (*)())&resize_login_handler);
