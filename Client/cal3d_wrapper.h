...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalAnimationState CalAnimation_GetState(CalAnimation *self);
  CAL3D_WRAPPER_API float CalAnimation_GetTime(CalAnimation *self);
  CAL3D_WRAPPER_API enum CalAnimationType CalAnimation_GetType(CalAnimation *self);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalAnimationAction_Execute(CalAnimationAction *self, float delayIn, float delayOut);
  CAL3D_WRAPPER_API CalAnimationAction *CalAnimationAction_New(CalCoreAnimation *pCoreAnimation);
  CAL3D_WRAPPER_API enum CalBoolean CalAnimationAction_Update(CalAnimationAction *self, float deltaTime);

//****************************************************************************//
// CalAnimationCycle wrapper functions declaration                            //
//****************************************************************************//

  CAL3D_WRAPPER_API enum CalBoolean CalAnimationCycle_Blend(CalAnimationCycle *self, float weight, float delay);
  CAL3D_WRAPPER_API void CalAnimationCycle_Delete(CalAnimationCycle *self);
  CAL3D_WRAPPER_API CalAnimationCycle *CalAnimationCycle_New(CalCoreAnimation *pCoreAnimation);
  CAL3D_WRAPPER_API void CalAnimationCycle_SetAsync(CalAnimationCycle *self, float time, float duration);
  CAL3D_WRAPPER_API enum CalBoolean CalAnimationCycle_Update(CalAnimationCycle *self, float deltaTime);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API CalBone *CalBone_New(CalCoreBone* coreBone);
  CAL3D_WRAPPER_API void CalBone_SetSkeleton(CalBone *self, CalSkeleton *pSkeleton);
  CAL3D_WRAPPER_API void CalBone_SetTranslation(CalBone *self, CalVector *pTranslation);
  CAL3D_WRAPPER_API void CalBone_SetRotation(CalBone *self, CalQuaternion *pRotation);
  CAL3D_WRAPPER_API void CalBone_SetCoreState(CalBone *self);
  CAL3D_WRAPPER_API void CalBone_SetCoreStateRecursive(CalBone *self);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API void CalCoreAnimation_Scale(CalCoreAnimation *self, float factor);
  CAL3D_WRAPPER_API void CalCoreAnimation_AddCoreTrack(CalCoreAnimation *self, CalCoreTrack *pCoreTrack);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalCoreBone_AddChildId(CalCoreBone *self, int childId);
...
//  CAL3D_WRAPPER_API std::list<int>& CalCoreBone_GetListChildId(CalCoreBone *self);
  ...
  CAL3D_WRAPPER_API CalCoreBone *CalCoreBone_New(const char* name);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API void CalCoreKeyframe_GetRotation(CalCoreKeyframe *self, CalQuaternion *outQ);
  CAL3D_WRAPPER_API float CalCoreKeyframe_GetTime(CalCoreKeyframe *self);
  CAL3D_WRAPPER_API void CalCoreKeyframe_GetTranslation(CalCoreKeyframe *self, CalVector *outV);
...
//  CAL3D_WRAPPER_API std::vector<Map>& CalCoreMaterial_GetVectorMap(CalCoreMaterial *self);
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalCoreMaterial_Reserve(CalCoreMaterial *self, int mapCount);
...
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreMaterial_SetMap(CalCoreMaterial *self, int mapId, CalCoreMaterial::Map *pMap);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreMaterial_SetMapUserData(CalCoreMaterial *self, int mapId, CalUserData userData);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API void CalCoreMesh_Scale(CalCoreMesh *self,float factor);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_CreateCoreMaterialThread(CalCoreModel *self, int coreMaterialThreadId);
  ...
  CAL3D_WRAPPER_API int CalCoreModel_LoadCoreMesh(CalCoreModel *self, const char *strFilename);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_LoadCoreSkeleton(CalCoreModel *self, char *strFilename);
  CAL3D_WRAPPER_API CalCoreModel *CalCoreModel_New(const char* name);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_SaveCoreAnimation(CalCoreModel *self, char *strFilename, int coreAnimtionId);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_SaveCoreMaterial(CalCoreModel *self, char *strFilename, int coreMaterialId);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_SaveCoreMesh(CalCoreModel *self, char *strFilename, int coreMeshId);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_SaveCoreSkeleton(CalCoreModel *self, char *strFilename);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreModel_SetCoreMaterialId(CalCoreModel *self, int coreMaterialThreadId, int coreMaterialSetId, int coreMaterialId);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API void CalCoreSkeleton_Scale(CalCoreSkeleton *self,float factor);
...
//  CAL3D_WRAPPER_API std::vector<CalCoreBone *>& CalCoreSkeleton_GetVectorCoreBone(CalCoreSkeleton *self);
  ...
  CAL3D_WRAPPER_API int CalCoreSkeleton_GetCoreBonesNumber(CalCoreSkeleton *self);
...
//  CAL3D_WRAPPER_API std::vector<CalCoreSubmesh::Vertex>& CalCoreSubmesh_GetVectorVertex(CalCoreSubmesh *self);
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_Reserve(CalCoreSubmesh *self, int vertexCount, int textureCoordinateCount, int faceCount, int springCount);
  CAL3D_WRAPPER_API void CalCoreSubmesh_SetCoreMaterialThreadId(CalCoreSubmesh *self, int coreMaterialThreadId);
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_SetFace(CalCoreSubmesh *self, int faceId, CalCoreSubmesh::Face *pFace);
  CAL3D_WRAPPER_API void CalCoreSubmesh_SetLodCount(CalCoreSubmesh *self, int lodCount);
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_SetPhysicalProperty(CalCoreSubmesh *self, int vertexId, CalCoreSubmesh::PhysicalProperty *pPhysicalProperty);
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_SetSpring(CalCoreSubmesh *self, int springId, CalCoreSubmesh::Spring *pSpring);
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_SetTextureCoordinate(CalCoreSubmesh *self, int vertexId, int textureCoordinateId, CalCoreSubmesh::TextureCoordinate *pTextureCoordinate);
//  CAL3D_WRAPPER_API enum CalBoolean CalCoreSubmesh_SetVertex(CalCoreSubmesh *self, int vertexId, CalCoreSubmesh::Vertex *pVertex);
CAL3D_WRAPPER_API enum CalBoolean  CalCoreSubmesh_IsTangentsEnabled(CalCoreSubmesh *self, int mapId);
CAL3D_WRAPPER_API enum CalBoolean  CalCoreSubmesh_EnableTangents(CalCoreSubmesh *self, int mapId, enum CalBoolean enabled);

//****************************************************************************//
// CalCoreTrack wrapper functions declaration                                 //
//****************************************************************************//

  CAL3D_WRAPPER_API enum CalBoolean CalCoreTrack_AddCoreKeyframe(CalCoreTrack *self, CalCoreKeyframe *pCoreKeyframe);
...
//  CAL3D_WRAPPER_API std::map<float, CalCoreKeyframe *>& CalCoreTrack_GetMapCoreKeyframe(CalCoreTrack *self);
  CAL3D_WRAPPER_API enum CalBoolean CalCoreTrack_GetState(CalCoreTrack *self, float time, CalVector *pTranslation, CalQuaternion *pRotation);
  CAL3D_WRAPPER_API CalCoreTrack *CalCoreTrack_New();
  CAL3D_WRAPPER_API enum CalBoolean CalCoreTrack_SetCoreBoneId(CalCoreTrack *self, int coreBoneId);

  // Added for missiles needs
  CAL3D_WRAPPER_API int CalCoreTrack_GetCoreKeyframeCount(CalCoreTrack *self);
  CAL3D_WRAPPER_API CalCoreKeyframe * CalCoreTrack_GetCoreKeyframe(CalCoreTrack *self, int i);
...
//  CAL3D_WRAPPER_API std::vector<CalSubmesh *>& CalMesh_GetVectorSubmesh(CalMesh *self);
  CAL3D_WRAPPER_API CalMesh *CalMesh_New(CalCoreMesh *pCoreMesh);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalMixer_BlendCycle(CalMixer *self, int id, float weight, float delay);
  CAL3D_WRAPPER_API enum CalBoolean CalMixer_ClearCycle(CalMixer *self, int id, float delay);
  CAL3D_WRAPPER_API void CalMixer_Delete(CalMixer *self);
  CAL3D_WRAPPER_API enum CalBoolean CalMixer_ExecuteAction(CalMixer *self, int id, float delayIn, float delayOut);
  CAL3D_WRAPPER_API void CalMixer_RemoveAction(CalMixer *self,int id);
  CAL3D_WRAPPER_API CalMixer *CalMixer_New(CalModel *pModel);
  ...
  CAL3D_WRAPPER_API void CalMixer_SetAnimationTime(CalMixer *self, float animationTime);

//****************************************************************************//
// CalModel wrapper functions declaration                                     //
//****************************************************************************//

  CAL3D_WRAPPER_API enum CalBoolean CalModel_AttachMesh(CalModel *self, int coreMeshId);
  CAL3D_WRAPPER_API void CalModel_Delete(CalModel *self);
  CAL3D_WRAPPER_API enum CalBoolean CalModel_DetachMesh(CalModel *self, int coreMeshId);
...
//  CAL3D_WRAPPER_API std::vector<CalMesh *>& CalModel_GetVectorMesh(CalModel *self);
  CAL3D_WRAPPER_API CalModel *CalModel_New(CalCoreModel* pCoreModel);
  ...
  CAL3D_WRAPPER_API CalMesh *CalModel_GetAttachedMesh(CalModel *self,int i);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API int CalPhysique_CalculateTangentSpaces(CalPhysique *self, CalSubmesh *pSubmesh, int mapId, float *pTangentSpaceBuffer);
  CAL3D_WRAPPER_API void CalPhysique_Delete(CalPhysique *self);
  CAL3D_WRAPPER_API CalPhysique *CalPhysique_New(CalModel* pModel);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API void CalQuaternion_Invert(CalQuaternion *self);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalRenderer_BeginRendering(CalRenderer *self);
  ...
  CAL3D_WRAPPER_API void CalRenderer_GetAmbientColor(CalRenderer *self, uint8_t *pColorBuffer);
  CAL3D_WRAPPER_API void CalRenderer_GetDiffuseColor(CalRenderer *self, uint8_t *pColorBuffer);
  ...
  CAL3D_WRAPPER_API void CalRenderer_GetSpecularColor(CalRenderer *self, uint8_t *pColorBuffer);
  ...
  CAL3D_WRAPPER_API int CalRenderer_GetTangentSpaces(CalRenderer *self, int mapId, float *pTangentSpaceBuffer);
  CAL3D_WRAPPER_API enum CalBoolean  CalRenderer_IsTangentsEnabled(CalRenderer *self, int mapId);
  CAL3D_WRAPPER_API CalRenderer *CalRenderer_New(CalModel* pModel);
  CAL3D_WRAPPER_API enum CalBoolean CalRenderer_SelectMeshSubmesh(CalRenderer *self, int meshId, int submeshId);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalSaver_SaveCoreAnimation(CalSaver *self, char *strFilename, CalCoreAnimation *pCoreAnimation);
  CAL3D_WRAPPER_API enum CalBoolean CalSaver_SaveCoreMaterial(CalSaver *self, char *strFilename, CalCoreMaterial *pCoreMaterial);
  CAL3D_WRAPPER_API enum CalBoolean CalSaver_SaveCoreMesh(CalSaver *self, char *strFilename, CalCoreMesh *pCoreMesh);
  CAL3D_WRAPPER_API enum CalBoolean CalSaver_SaveCoreSkeleton(CalSaver *self, char *strFilename, CalCoreSkeleton *pCoreSkeleton);
...
//  CAL3D_WRAPPER_API std::vector<CalBone *>& CalSkeleton_GetVectorBone(CalSkeleton *self);
  ...
  CAL3D_WRAPPER_API CalSkeleton *CalSkeleton_New(CalCoreSkeleton* pCoreSkeleton);
  CAL3D_WRAPPER_API void CalSkeleton_GetBoneBoundingBox(CalSkeleton *self, float *min, float *max);
  CAL3D_WRAPPER_API void CalSkeleton_CalculateBoundingBoxes(CalSkeleton *self);
  ...
  CAL3D_WRAPPER_API int CalSkeleton_GetBonesNumber(CalSkeleton *self);
...
//****************************************************************************//
  ...
  CAL3D_WRAPPER_API CalSpringSystem *CalSpringSystem_New(CalModel *pModel);
...
//  CAL3D_WRAPPER_API std::vector<CalVector>& CalSubmesh_GetVectorVertex(CalSubmesh *self);
  ...
  CAL3D_WRAPPER_API enum CalBoolean CalSubmesh_HasInternalData(CalSubmesh *self);
  CAL3D_WRAPPER_API CalSubmesh *CalSubmesh_New(CalCoreSubmesh* coreSubmesh);
