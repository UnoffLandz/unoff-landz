...
uint64_t ec_cur_time, ec_last_time;
...
extern "C" int ec_in_range(float x, float y, float z, uint64_t effect_max_time)
{
...
{
	uint8_t raw_code[54];
	const uint8_t*const code2 = (const uint8_t*const) code;
    int i = 0;
