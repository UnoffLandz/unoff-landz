...
int get_tile_map_sizes(const char *file_name, int *x, int *y)
{
    ...
    file_mem = (char *)el_get_pointer(file);
...
static int do_load_map(const char *file_name, update_func *update_function)
{
    ...
    tile_map = (uint8_t *)calloc (tile_map_size_x*tile_map_size_y, 1);
    ...
    height_map = (uint8_t *)calloc (tile_map_size_x*tile_map_size_y*6*6, 1);
    ...
    else
    {
        ...
        occupied = (char *)calloc (tile_map_size_x*tile_map_size_y*6*6, 1);
